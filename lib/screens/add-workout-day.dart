...
class _AddWorkoutDayState extends State<AddWorkoutDay> {
  ...
  void _addDrillsBlock() {
    ...
    switch (_defaultNewDrillType) {
      ...
      case 'For Time':
        newBlock =
            WorkoutForTimeDrillBlock(drills: [WorkoutDrill(), WorkoutDrill()],timeCapMin: 10, rounds: 2, restBetweenRoundsMin: 1);
        break;
      case 'AMRAP':
        newBlock =
            WorkoutAmrapDrillBlock(drills: [WorkoutDrill(), WorkoutDrill()], minutes: 10);
        break;
      case 'EMOM':
        newBlock =
            WorkoutEmomDrillBlock(drills: [WorkoutDrill(), WorkoutDrill()], timeCapMin: 10, intervalMin: 1);
        break;
      case 'Rest':
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('YaryteFit // Create Day Plan'),
        actions: <Widget>[
