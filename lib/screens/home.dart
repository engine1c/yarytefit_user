...
import 'package:yarytefit/components/active-workouts.dart';
import 'package:yarytefit/components/workouts-list.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('YaryteFit // ${sectionIndex == 0 ? 'Active Workouts' : 'Find Workouts'}'),
